      ...
      <div class="modal-body">
        ...
        @method('PUT')
            ...
            <div class="input-group mb-3">
                <input id="description" class="form-control" type="text" placeholder="Description" name="description" value="{!! $expense->description !!}">
            </div>
            ...
            <div class="input-group mb-3">
                <input id="amount" type="text" class="form-control" name="amount" placeholder="Amount" aria-label="Amount (to the nearest dollar)" value="{!! $expense->amount !!}">
            ...
            <div class="input-group mb-3">
                ...
                <input type="date" id="date" class="form-control" name="date" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="{!! $expense->date !!}">
            </div>
            ...
            <div class="input-group mb-3">
                <input id="receipt" type="file" class="form-control" name="receipt" value="{!! $expense->receipt !!}">
                    @error('receipt')
                        <span class="invalid-feedback" role="alert">
